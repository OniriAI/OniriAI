...
@testset "oniriOS.jl" begin
    ...
    @testset "Rate Limiting" begin
        ...
        oniriOS.TwitterRateLimiter.update_rate_limit(scraper.rate_limiter, endpoint, response)
        @test haskey(scraper.rate_limiter.endpoints, endpoint)
        
        # Test Rate Limit Check
        oniriOS.TwitterRateLimiter.check_rate_limit(scraper.rate_limiter, endpoint)
